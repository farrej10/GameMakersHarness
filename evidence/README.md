...
- `screenshots/`: reference-game captures produced by Playwright and labeled as fixture evidence.
- `LIVE-RUNS.md`: provenance, model, timing, cost, visual review, and recovery summary for two credentialed runs.
- `live-greenhouse/` and `live-moon/`: redacted live reports, event timelines, verification results, specifications, and screenshots.
