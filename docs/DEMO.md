...
| 0:45-1:25 | Play Storm Courier: dash, ordered shrines, guarding enemies, survival exit | The output has a specific identity and combined mechanics |
...
4. Open the verified build from the report and demonstrate dash movement, ordered collection, a guarding sentinel, damage, survival pressure, and the exit objective.
